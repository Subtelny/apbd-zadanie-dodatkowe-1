...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            var nullData = new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } };
            return empData.Union(nullData);
        }
        ...
        public static IEnumerable<object> Task11()
        {
            return Emps.GroupBy(emp => emp.Deptno)
                ...
                .Join(Depts,
                    group => group.Key,
                    dept => dept.Deptno,
                    (group, dept) => new { name = dept.Dname, numOfEmployees = group.Count() });
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            return Depts.GroupJoin(deptWithEmpCount,
                    dept => dept.Deptno,
                    deptEmpCount => deptEmpCount.Deptno,
                    (dept, deptEmpCounts) => new { Dept = dept, EmpCount = deptEmpCounts.FirstOrDefault()?.Count ?? 0 })
                .Where(dept => dept.EmpCount == 5 || dept.EmpCount == 0)
                .OrderBy(dept => dept.Dept.Dname)
        ...
        public static IEnumerable<Dept> Task15()
        {
            return Emps.Where(emp => emp.Job.Contains("A"))
                ...
                .Select(group => new Dept { Dname = group.Key, Deptno = group.Count() });
        }
